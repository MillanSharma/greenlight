...
import (
	...
	"greenlight.millansharma.net/internal/jsonlog"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://greenlight:goroutine@localhost/greenlight?sslmode=disable", "PostgreSQL DSN")
